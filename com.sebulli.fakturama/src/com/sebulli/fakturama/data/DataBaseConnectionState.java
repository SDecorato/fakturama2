...
/**
 * Thsi singleton stores the state of the connection to the data base in
 * a local variable. A singleton enum is used to read the state, without
 * accessing to the Data class. 
 * 
 * @author Gerd Bartelt
 */
