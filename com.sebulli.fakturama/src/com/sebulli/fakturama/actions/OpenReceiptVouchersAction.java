...
/**
 * This action opens the receipt vouchers in a table view.
 * 
 * @author Gerd Bartelt
 */
public class OpenReceiptVouchersAction extends Action {
	...
	public OpenReceiptVouchersAction() {
		...
		setId(ICommandIds.CMD_OPEN_RECEIPTVOUCHERS);

		// Associate the action with a pre-defined command, to allow key
		// bindings.
		setActionDefinitionId(ICommandIds.CMD_OPEN_RECEIPTVOUCHERS);
	 ...
	 * Run the action
	 * 
	 * Open the receipt vouchers in an table view and close the other table views.
	 */
	@Override
	public void run() {
		ViewManager.showView(ViewReceiptVoucherTable.ID);
	}
}
