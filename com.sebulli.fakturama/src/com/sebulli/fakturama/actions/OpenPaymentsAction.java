...
/**
 * This action opens the payments in a table view.
 * 
 * @author Gerd Bartelt
 */
public class OpenPaymentsAction extends Action {
	...
	public OpenPaymentsAction() {
		...
		// bindings.
		setActionDefinitionId(ICommandIds.CMD_OPEN_PAYMENTS);
	 ...
	 * Run the action
	 * 
	 * Open the payments in an table view and close the other table views.
	 */
	@Override
	public void run() {
		ViewManager.showView(ViewPaymentTable.ID);
	}
}