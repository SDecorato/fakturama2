 ...
 * 
 */
public class ViewTestTable extends ViewDataSetTable {

	// ID of this view
	public static final String ID = "com.sebulli.fakturama.views.datasettable.viewTestTable";
 ...
 * 
 */
//public abstract class ViewExpenditureVoucherTable extends ViewDataSetTable{
	
	// ID of this view
//	public static final String ID = "com.sebulli.fakturama.views.datasettable.xxxTable";
...
/*
		...
		super.createPartControl(parent, DataSetVoucher.class, false, true, ContextHelpConstants.EXPENDITURE_VOUCHER_TABLE_VIEW);//, ContextHelpConstants.EXPENDITURE_VOUCHER_TABLE_VIEW);
