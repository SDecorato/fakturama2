...
/**
 * Manages the OpenOffice documents. Stores a list of all open documents
 * and closes all when closing Fakturama.
 * 
 * @author Gerd Bartelt
 */
public enum OOManager {
	 ...
	 * 
	 * @param document The UniDataSet that will be exported
	 * 			into an OpenOffice Writer document
	 * @param template The Filename of the OpenOffice Template
	 */
