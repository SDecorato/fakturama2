 ...
 * @author Gerd Bartelt
 */
public class MoveEntryUpAction extends Action {

	/**
	 * default constructor
	 */
	public MoveEntryUpAction() {
		...
		setId(ICommandIds.CMD_MOVE_UP);

		// Associate the action with a predefined command, to allow key
		// bindings.
		setActionDefinitionId(ICommandIds.CMD_MOVE_UP);
		setImageDescriptor(Activator.getImageDescriptor("/icons/16/up_16.png"));
	}
