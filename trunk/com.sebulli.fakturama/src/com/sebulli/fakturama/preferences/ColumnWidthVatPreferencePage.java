 ...
 * @author Gerd Bartelt
 */
public class ColumnWidthVatPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new IntegerFieldEditor("COLUMNWIDTH_VATS_STANDARD", _("Standard"), getFieldEditorParent()));
		//T: Preference page "Column width" - Use the same text as in the heading of the corresponding table
		addField(new IntegerFieldEditor("COLUMNWIDTH_VATS_NAME", _("Name"), getFieldEditorParent()));
		//T: Preference page "Column width" - Use the same text as in the heading of the corresponding table
		addField(new IntegerFieldEditor("COLUMNWIDTH_VATS_DESCRIPTION", _("Description"), getFieldEditorParent()));
		//T: Preference page "Column width" - Use the same text as in the heading of the corresponding table
		addField(new IntegerFieldEditor("COLUMNWIDTH_VATS_VALUE", _("Value"), getFieldEditorParent()));
	...
	public static void setInitValues(IEclipsePreferences node) {
		node.put("COLUMNWIDTH_VATS_STANDARD", "55");
		node.put("COLUMNWIDTH_VATS_NAME", "120");
		node.put("COLUMNWIDTH_VATS_DESCRIPTION", "200");
		node.put("COLUMNWIDTH_VATS_VALUE", "70");
	}
